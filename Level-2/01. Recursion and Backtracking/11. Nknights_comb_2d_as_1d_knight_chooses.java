...
public class Main {
    ...
    public static boolean IsKnightSafe(boolean[][] chess, int r, int c) {
        ...
        if(r-2 >= 0 && c-1 >= 0 && chess[r-2][c-1] == true) {
            return false;
        }
        else if(r-2 >= 0 && c+1 < chess[0].length && chess[r-2][c+1] == true) {
            return false;
        }
        else if(r-1 >= 0 && c+2 < chess[0].length && chess[r-1][c+2] == true) {
            return false;
        }
        else if(r-1 >= 0 && c-2 >= 0 && chess[r-1][c-2] == true) {
            return false;
        }
